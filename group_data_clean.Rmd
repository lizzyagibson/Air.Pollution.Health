...
meteor <- rbind(rh_dewpoint, temp) %>% 
  filter(state_name == "New York" & county_name %in% c("Queens", "Kings", "New York", "Bronx", "Richmond") & poc == 1)

partic <- rbind(pm_25_FRM_FEM_mass, pm_25_spec) %>% 
  filter(state_name == "New York" & county_name %in% c("Queens", "Kings", "New York", "Bronx", "Richmond") & parameter_name %in% c("Sodium PM2.5 LC",
                                             "Aluminum PM2.5 LC",
                                             "Barium PM2.5 LC",
                                             "Bromine PM2.5 LC",
                                             "Calcium PM2.5 LC",
